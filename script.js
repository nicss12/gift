...
let mountainBehind = document.getElementById('mountainBehind')
let mountainFront = document.getElementById('mountainFront')
let text = document.getElementById('mountainText')
...
window.addEventListener('scroll', function () {
    let value = window.scrollY - 1600;
    console.log(value)

    daytext.style.top = value * -0.1 + "%"
...
(function (canvas) {
    ...
    function render() {
        ...
        var newTime = new Date(9/5/23).getTime() / 1000,
